...
```
# bash
.\l1tool --file filename --lam 2000 --rho 80 --periods 365.25,186.725 --verbose true --solve cvxopt --out output_filename
```
...
= verbose: bool true, display the solve information
